...
This blog is a continuation of [part 1](http://blog.isaack.io/articles/2016-08/Jenkins-CICD-Getting-Started-With-Groovy-Part-1) where I describe how to get the Jenkins master container configured.
...
![](http://i.imgur.com/aKWiVjJ.png)


### Configuring Jenkins

The first step is to configure Jenkins with Github. Is accomplished by configuring the Github-Plugin that was installed in [part 1](http://blog.isaack.io/articles/2016-08/Jenkins-CICD-Getting-Started-With-Groovy-Part-1) as one of the plugins.  

Navigate to the the url ```http://jenkins/configure```. Scroll down to the section labeled Github. Select Github -> Advanced

![](http://i.imgur.com/0FXcw4N.jpg)
...
![](http://i.imgur.com/nh1CUCC.jpg)

Under **integrations and webhooks**, select **add service** and search for the **Jenkins (Github Plugin)**

![](http://i.imgur.com/0OQt0V1.jpg)

Navigate to **webhooks** and under **Jenkins hook url**, add your Jenkins URL ```http:/jenkin/github-webook/``` and click test service to send a post pull requqest to the Jenkins API webook

![](http://i.imgur.com/Vv7ACib.jpg)
...
You start by setting up a multibranch pipeline. Navigate to the following url ```http://jenkins/view/All/newJob```.
